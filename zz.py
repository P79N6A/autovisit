...
#Recoder1 by ./Mr.Java404
#Recoder2 by ./rahmadz@fr34kz.tech
#Date & Time 15/01/2019 [06:09]
...
print "|  Auto Visit 2019  |"
print "|   fr34kz.tech     |"
print "|___ .@yaelahferr___|"
print "    .' \:.    / '.   "
print "   / .-'':._.'--. \   "
print "   |/    /||\    \|   "
print "	(+ '*)	   "
...
print B+R+'               \!/Notice\!/'
print B+BL+'#-----------------------------------------#'
print B+W+'[x] Url Diawalin Dengan http or https'
print B+W+'[x] Tool Menggunakan Socks / Proxy Jika Error Silahkan cek listproxy !'
print B+W+'[x] Jika Saat Bot Sedang Berjalan Lalu [Proxy Error] Coba ganti listproxy !'
print B+BL+'#-----------------------------------------#'
print B+R+'               \!/WARNING\!/'
print B+BL+'#-----------------------------------------#'
...
def loadproxy():
	...
	print B+W+"\n[-] Error : Cek Proxy mu cok dah dimasukin blom !!!!\n"+N
	sys.exit(1)
